...
getCards('type=NFC_TAG&page=1&perPage=14');
</script>
...
<template>
    <div class="q-pa-lg">
        ...
        <div class="row justify-between items-center page-header">
            <h2 class="text-h4 text-bold q-my-none">Карты</h2>
            ...
            >
                <q-btn
                        ...
                        size="12px"
                        @click="$router.push('/cards/all_report')"
                />
                ...
                <q-btn
                        ...
                        class="btn-default"
                        label="Инструкция"
                        href="https://uprating.org/Card-issue"
                        target="_blank"
                        size="12px"
                />
                ...
                <q-btn
                        ...
                        label="Добавить"
                        size="12px"
                        @click="$router.push('/cards/0/main')"
                />
            ...
            <div
                    ...
                    class="infoCard"
                    style="margin: 10px 0; max-width: 100%; white-space: normal; width: 100%; flex: none;"
            >
            ...
            <div
                    ...
                    style="margin: 10px 0; max-width: 100%; white-space: normal; width: 100%; flex: none;"
            >
                Для выпуска большего кол-ва тестовых карт/qr кодов - обращаться по тел. +7 (995)169-62-53 / На почту
                nfcstandart@gmail.com / Telegram https://t.me/Up_Rating
            </div>
            ...
            <div
                    ...
                    style="margin: 10px 0; max-width: 100%; white-space: normal; width: 100%; flex: none;"
            >
                Поздравляем, Ваша карта выпущена. Далее нужно создать список ссылок, по которым вы планируете
                перенаправлять смартфоны ваших клиентов.
                Нажмите на кнопку действия в строке нужной карты и перейдите в Просмотр карты. Далее вверху нажмите на
                раздел Ссылки карты.
            </div>
        </div>
    </div>
        ...
        >
            <template v-if="isOrgAdmin" v-slot:noresult>
                ...
                >
                    ...
                    Нажмите кнопку "
                    <router-link to="/cards/new">Выпуск карты</router-link>
                    ".
                </div>
            </template>
                ...
                >
                    <q-list>
                        ...
                        <q-item
                                ...
                                clickable
                                class="items-center"
                                @click="$router.push(`/cards/${props.row.id}/report`)"
                        >
        ...
        >
            <div class="q-mb-lg">
                <div class="text-h6 text-bold">
                    Вы действительно хотите {{ !blockedItem.isBlocked ? 'разблокировать' : 'заблокировать' }} этот
                    объект?
                </div>
            </div>
