...
function sendReport(byEmail, id, fileName) {
    ...
    getData(`/admin/doc/redirect_report_unique?startDate=${startDate.value}&endDate=${endDate.value}&organization=${id}&send_by_email=true&type=NFC_TAG`,
...
function downloadReport(id, fileName) {
    ...
    fetch(`${import.meta.env.VITE_API_URL}/admin/doc/redirect_report_unique?startDate=${startDate.value}&endDate=${endDate.value}&organization=${id}&type=NFC_TAG`, {
        method: 'GET',
        headers: {
...
function getReport(byEmail, id) {
    ...
    getData(`/admin/doc/redirect_report_unique?startDate=${startDate.value}&endDate=${endDate.value}&organization=${id}&renderWeb=true&type=NFC_TAG`,
        METHODS.GET)
        .then((response) => {
