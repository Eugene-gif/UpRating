...
<template>
      ...
      <div class="row q-gutter-md justify-end">
        <div class="q-gutter-sm">
          ...
          <q-btn
              ...
              :disable="+ID2 === 0"
              @click="$router.push(`/organization/${ID}/card/${ID2}/link/0`)"
              size="12px"
          />
          ...
          <q-btn
              ...
              :disable="+ID2 === 0"
              size="12px"
              @click="$router.push(`/cards/${ID2}/report`)"
          />
  ...
  <q-tabs
      ...
      narrow-indicator
  >
    <q-route-tab :to="`/organization/${ID}/card/${ID2}/main`" name="main" label="Основная информация"/>
    <q-route-tab :disable="+ID2 === 0" :to="`/organization/${ID}/card/${ID2}/links`" name="links" label="Ссылки карты"/>
  </q-tabs>
