...
<template>
        ...
        <div class="row justify-between items-center page-header">
            ...
            <div class="row q-gutter-md justify-end">
                <q-btn
                        ...
                        :disable="+ID === 0"
                        @click="router.push(`/qr_codes/${ID}/extend`)"
                        target="_blank"
                        size="12px"
                />
                ...
                <q-btn
                        ...
                        :disable="+ID === 0"
                        size="12px"
                        @click="$router.push(`/qr_codes/${ID}/report`)"
                />
                ...
                <q-btn
                        ...
                        size="12px"
                        @click="$router.push(`/qr_codes/${ID}/link/0`)"
                />
    ...
    <q-tabs
            ...
            narrow-indicator
    >
        <q-route-tab :to="`/qr_codes/${ID}/main`" name="main" label="Основная информация"/>
        <q-route-tab :disable="+ID === 0" :to="`/qr_codes/${ID}/links`" name="links" label="Ссылки QR кода"/>
    </q-tabs>
